...
// 3  Slide04Sampling
// 4  Slide06AIModels
// 5  Slide07MachineLearning
// 6  Slide08NeuralNetworks
// 7  Slide09Applications1  (Energía)
// 8  Slide10Applications2  (Vehículos)
// 9  Slide11Limits
// 10 Slide13Agentic        (Sistemas agénticos)
// 11 Slide14Ethics         (Ética)
// 12 Slide12Conclusions    (Conclusiones)
      ...
      <div className="reveal" style={{ zIndex: 2, position: 'relative' }}>
        <div className="slides">
          <Slide01Cover
            ...
            onJumpToConclusions={() => goToSlide(12)}
          />
          <Slide02Question active={currentSlide === 1} />
          <Slide03Digitalization />
          <Slide04Sampling active={currentSlide === 3} />
          <Slide06AIModels />
          <Slide07MachineLearning active={currentSlide === 5} />
          <Slide08NeuralNetworks active={currentSlide === 6} />
          <Slide09Applications1 />
          <Slide10Applications2 active={currentSlide === 8} />
          <Slide11Limits />
          <Slide13Agentic active={currentSlide === 10} />
          <Slide14Ethics />
          <Slide12Conclusions active={currentSlide === 12} />
        </div>
      </div>
    </div>
  )
